    ...
    <div className="flex flex-wrap items-center gap-3 sm:gap-6 px-4 sm:px-6 py-3 glass-panel rounded-none border-x-0 border-t-0">
      ...
      <div className="ml-auto flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center justify-center p-1.5 rounded-lg text-muted-foreground hover:text-neon-cyan hover:bg-neon-cyan/10 transition-all duration-200 group"
          title="Activity Calendar"
        >
          <CalendarDays className="w-4 h-4 transition-transform duration-300 group-hover:scale-110" />
        </button>
        <div className="h-4 w-px bg-border/30" />
        <button
